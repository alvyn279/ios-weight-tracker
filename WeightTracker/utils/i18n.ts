export const i18n = {
  ...
  general_done: 'Done',
  general_save: 'Save',
  general_somethingWentWrong: 'Something went wrong.',
  weightEditor_enterWeight_prompt: 'Enter your weight:',
  ...
  weightEditor_dateTimePicker_title: 'Select date and time',
